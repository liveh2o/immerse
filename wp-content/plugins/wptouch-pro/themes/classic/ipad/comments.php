...
<?php if ( comments_open() ) : ?>
	...
	<?php if ( get_option('comment_registration') && !is_user_logged_in() ) : ?>
		<br />
		<div class="aligncenter"><a class="reply-to-comment button" href="#"><?php _e( "Log In To Comment", "wptouch-pro" ); ?></a></div>
	<?php else : ?>
		<br />
		<div class="aligncenter"><a class="leave-a-comment button" href="#"><?php _e( "Leave A Comment", "wptouch-pro" ); ?></a></div>
	<?php endif; ?>
