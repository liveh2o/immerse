...
<form method="post" action="" id="bnc-form" class="<?php if ( $wptouch_pro->locale ) echo 'locale-' . strtolower( $wptouch_pro->locale ); ?>">
	<div id="bnc" class="<?php echo $current_scheme; ?> <?php if ( WPTOUCH_PRO_BETA ) { echo 'beta'; } else { echo 'normal'; } ?> wrap">
		...
		<div id="wptouch-admin-form">		
			...
			<div id="wptouch-tabbed-area"  class="round-6 box-shadow <?php if ( wptouch_get_bloginfo( 'support_licenses_total' ) >= 5 ){ echo 'developer'; } if ( $settings->admin_client_mode_hide_tools ) { echo ' client-mode'; } ?>">
		...
		<ul id="link-menu">
			...
			<li><a href="http://www.bravenewcode.com/support/profile/" target="_blank"><?php _e( "My Account", "wptouch-pro" ); ?></a> |</li>
			...
			<li><a href="http://twitter.com/bravenewcode" target="_blank"><?php _e( "Twitter &rsaquo; BNC", "wptouch-pro" ); ?></a> |</li>
			<li><a href="http://www.bravenewcode.com/general/terms/" target="_blank"><?php _e( "Terms &amp; Legal", "wptouch-pro" ); ?></a></li>
		</ul>
		<div class="poof">&nbsp;</div>
