...
<div class='wptouch-setting' id='touchboard'>
	...
	<?php if ( wptouch_has_proper_auth()  && !$settings->admin_client_mode_hide_licenses ) { ?>	
		<?php if ( wptouch_has_license() ) { ?>	
			<div class="box-holder round-6" id="support-threads-box">
		...
		<?php } else { ?>
			...
			<div id="unlicensed-board" class="partial round-6">
				...
				<a href="#pane-5" id="target-pane-5" class="partial wptouch-admin-switch" rel="licenses"><?php _e( "Add a site license &raquo;", "wptouch-pro" ); ?></a>
			</div>		
		<?php } ?>
